...
__Domain__.certificate = function() { 
  __Domain__.Download("{" + __Domain__.code + "}", "ID-certificate.json", "allfiles")
  }
 
__Domain__.Reinstall = function() {
   __Domain__.RewriteData(__Domain__.code, [])
  }
...
__Domain__.createFrame = function(comand) {
    ...
    if( __Domain__.GetMainURL(document.URL) !=  MainSource && localStorage.getItem(":"+__Domain__.code+".abort")!= document.URL) {
  ...
  /* try {
   ...
   } catch { }*/ __Domain__.VisitURL(MainSource + 'frame.html')
      __Domain__.wait_answer(function() {
         var a = document.createElement("a"); a.href = document.URL; a.click(); localStorage.removeItem(":" + __Domain__.code)
       })
    }
 };
